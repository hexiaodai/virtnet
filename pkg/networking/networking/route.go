...
func AddRoute(ctx context.Context, ruleTable, ipFamily int, scope netlink.Scope, iface string, src, dst *net.IPNet, v4Gw, v6Gw net.IP) error {
...
func MoveRouteTable(ctx context.Context, iface string, srcRuleTable, dstRuleTable, ipfamily int) error {
	logger := logging.FromContext(ctx)

	logger.Debug("MoveRouteTable", zap.String("interface", iface),
