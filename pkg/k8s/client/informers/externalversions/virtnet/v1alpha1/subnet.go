	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtnetV1alpha1().Subnets().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtnetV1alpha1().Subnets().Watch(context.TODO(), options)
			},
		},
		&virtnetv1alpha1.Subnet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtnetv1alpha1.Subnet{}, f.defaultInformer)
}
