...
import (
	...
	virtnetv1alpha1 "github.com/hexiaodai/virtnet/pkg/k8s/apis/virtnet/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtnetV1alpha1().IPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtnetV1alpha1().IPPools().Watch(context.TODO(), options)
			},
		},
		&virtnetv1alpha1.IPPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtnetv1alpha1.IPPool{}, f.defaultInformer)
}
