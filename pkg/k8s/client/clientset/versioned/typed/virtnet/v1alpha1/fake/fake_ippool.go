...
type FakeIPPools struct {
	Fake *FakeVirtnetV1alpha1
}

var ippoolsResource = schema.GroupVersionResource{Group: "virtnet", Version: "v1alpha1", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "virtnet", Version: "v1alpha1", Kind: "IPPool"}
