...
var subnetsResource = schema.GroupVersionResource{Group: "virtnet", Version: "v1alpha1", Resource: "subnets"}

var subnetsKind = schema.GroupVersionKind{Group: "virtnet", Version: "v1alpha1", Kind: "Subnet"}
