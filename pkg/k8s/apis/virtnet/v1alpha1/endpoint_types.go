...
// +kubebuilder:resource:categories={virtnet},path="endpoints",scope="Namespaced",shortName={endpoint},singular="endpoint"
...
// +kubebuilder:printcolumn:JSONPath=".status.ownerControllerType",description="ownerControllerType",name="OWNER-KIND",type=string
// +kubebuilder:printcolumn:JSONPath=".status.ownerControllerName",description="ownerControllerName",name="OWNER-NAME",type=string
