...
const (
	DefaultIPAMPluginLogFilePath        = "/var/log/virtnet/virtnest-ipam.log"
	DefaultCoordinatorPluginLogFilePath = "/var/log/virtnet/virtnest-coordinator.log"
	DefaultAgentLogFilePath             = "/var/log/virtnet/virtnest-agent.log"
	DefaultCtrlLogFilePath              = "/var/log/virtnet/virtnest-ctrl.log"
	DefaultCooFilePath                  = "/Users/hjm/go1.20.3/src/github.com/hexiaodai/cni/.examples/coordinator/coo.log"
...
func DefaultLogger() Logger {
	return NewLogger(&Logging{
		Level: LogLevel(string(LogLevelInfo)),
	})
}
