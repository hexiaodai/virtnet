...
func main() {
	...
	logger.Named(coordinatorypes.BinNamePlugin).With(zap.Any("os.Args", os.Args)).Debug("Starting VirtNest Coordinator plugin")

	skel.PluginMain(cmdAdd, cmdCheck, cmdDel, cnispecversion.All, "VirtNest Coordinator")
}
