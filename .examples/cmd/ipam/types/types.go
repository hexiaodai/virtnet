...
func LoadNetConf(argsStdin []byte) (*NetConf, error) {
	...
	return nil, fmt.Errorf("unsupported specified CNI version %s, the CNI versions supported by VirtNest: %v", netConf.CNIVersion, cnispecversion.All.SupportedVersions())
}
