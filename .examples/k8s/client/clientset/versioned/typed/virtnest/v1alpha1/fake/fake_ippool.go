...
var ippoolsResource = schema.GroupVersionResource{Group: "virtnest", Version: "v1alpha1", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "virtnest", Version: "v1alpha1", Kind: "IPPool"}
