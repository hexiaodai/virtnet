	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtnestV1alpha1().IPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtnestV1alpha1().IPPools().Watch(context.TODO(), options)
			},
		},
		&virtnestv1alpha1.IPPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtnestv1alpha1.IPPool{}, f.defaultInformer)
}
