...
func main() {
	...
	logger.Named(types.BinNamePlugin).With(zap.Any("os.Args", os.Args)).Debug("Starting VirtNet IPAM plugin")

	skel.PluginMain(cmdAdd, cmdCheck, cmdDel,
		cnispecversion.All,
		"VirtNet IPAM "+version)
}
...
func cmdAdd(args *skel.CmdArgs) error {
	...
	reply, err := ipamClient.Allocate(context.TODO(), &pbipam.AllocateRequest{
		...
		DefaultSubnet: conf.IPAM.DefaultSubnet,
	})
	if err != nil {
